...
router.get('/student/detail/:invoice', studentMgr.viewStudent);
router.post('/studentRegister/addSchedule', studentMgr.addSchedule)
...
router.put('/student/modifyStudent/:invoice', studentMgr.updateStudent);
